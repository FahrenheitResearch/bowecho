...
static WRF_FIELD_CATALOG: &[(&str, WrfFieldInfo)] = &[
    ...
    ("wrf_swdown",  info("Shortwave ↓ surface (SWDOWN)", "Downward solar flux reaching the ground", F::Sequential { lo: 0.0, hi: 1100.0 })),
    ("wrf_swnorm",  info("Shortwave ↓ slope-normal", "Downward solar flux normal to the terrain slope", F::Sequential { lo: 0.0, hi: 1100.0 })),
    ("wrf_gsw",     info("Shortwave net, surface", "Net solar flux absorbed at the ground", F::Sequential { lo: 0.0, hi: 1100.0 })),
    ("wrf_glw",     info("Longwave ↓ surface (GLW)", "Downward thermal (infrared) flux at the ground", F::Sequential { lo: 100.0, hi: 500.0 })),
    ("wrf_olr",     info("Longwave ↑ TOA (OLR)", "Outgoing longwave radiation at the top of the atmosphere — cold cloud tops read low", F::Sequential { lo: 80.0, hi: 340.0 })),
    ("wrf_swupt",   info("Shortwave ↑ TOA — reflected solar", "Solar flux reflected back out the top of the atmosphere", F::Sequential { lo: 0.0, hi: 1100.0 })),
    ("wrf_swuptc",  info("Shortwave ↑ TOA (clear-sky)", "Reflected solar at the top of the atmosphere assuming no clouds", F::Sequential { lo: 0.0, hi: 1100.0 })),
    ("wrf_swdnt",   info("Shortwave ↓ TOA — incoming solar", "Incoming solar flux at the top of the atmosphere", F::Sequential { lo: 0.0, hi: 1400.0 })),
    ("wrf_swdntc",  info("Shortwave ↓ TOA (clear-sky)", "Incoming solar at the top of the atmosphere, clear-sky", F::Sequential { lo: 0.0, hi: 1400.0 })),
    ("wrf_swupb",   info("Shortwave ↑ surface — reflected", "Solar flux reflected by the ground (albedo × downward SW)", F::Sequential { lo: 0.0, hi: 1100.0 })),
    ("wrf_swupbc",  info("Shortwave ↑ surface (clear-sky)", "Reflected solar at the ground assuming no clouds", F::Sequential { lo: 0.0, hi: 1100.0 })),
    ("wrf_swdnb",   info("Shortwave ↓ surface", "Downward solar flux at the ground (all-sky)", F::Sequential { lo: 0.0, hi: 1100.0 })),
    ("wrf_swdnbc",  info("Shortwave ↓ surface (clear-sky)", "Downward solar flux at the ground assuming no clouds", F::Sequential { lo: 0.0, hi: 1100.0 })),
    ("wrf_lwupt",   info("Longwave ↑ TOA", "Thermal flux leaving the top of the atmosphere (all-sky OLR)", F::Sequential { lo: 80.0, hi: 340.0 })),
    ("wrf_lwuptc",  info("Longwave ↑ TOA (clear-sky)", "Thermal flux leaving the top of the atmosphere assuming no clouds", F::Sequential { lo: 80.0, hi: 340.0 })),
    ("wrf_lwdnt",   info("Longwave ↓ TOA", "Downward thermal flux at the top of the atmosphere (near zero)", F::Unassigned)),
    ("wrf_lwdntc",  info("Longwave ↓ TOA (clear-sky)", "Downward thermal flux at the top of the atmosphere, clear-sky", F::Unassigned)),
    ("wrf_lwupb",   info("Longwave ↑ surface", "Thermal flux emitted upward by the ground (~σT⁴)", F::Sequential { lo: 200.0, hi: 650.0 })),
    ("wrf_lwupbc",  info("Longwave ↑ surface (clear-sky)", "Thermal flux emitted upward by the ground, clear-sky", F::Sequential { lo: 200.0, hi: 650.0 })),
    ("wrf_lwdnb",   info("Longwave ↓ surface", "Downward thermal flux at the ground (all-sky, ≈ GLW)", F::Sequential { lo: 100.0, hi: 500.0 })),
    ("wrf_lwdnbc",  info("Longwave ↓ surface (clear-sky)", "Downward thermal flux at the ground assuming no clouds", F::Sequential { lo: 100.0, hi: 500.0 })),
    // ── Radiation budget — accumulated (J m-2; range grows with sim time) ──
    ("wrf_acswupt",  info("Shortwave ↑ TOA (accum.)", "Time-integrated reflected solar at the top of the atmosphere", F::Unassigned)),
    ("wrf_acswuptc", info("Shortwave ↑ TOA clear-sky (accum.)", "Time-integrated clear-sky reflected solar at TOA", F::Unassigned)),
    ("wrf_acswdnt",  info("Shortwave ↓ TOA (accum.)", "Time-integrated incoming solar at the top of the atmosphere", F::Unassigned)),
    ("wrf_acswdntc", info("Shortwave ↓ TOA clear-sky (accum.)", "Time-integrated clear-sky incoming solar at TOA", F::Unassigned)),
    ("wrf_acswupb",  info("Shortwave ↑ surface (accum.)", "Time-integrated solar flux reflected by the ground", F::Unassigned)),
    ("wrf_acswupbc", info("Shortwave ↑ surface clear-sky (accum.)", "Time-integrated clear-sky reflected solar at the ground", F::Unassigned)),
    ("wrf_acswdnb",  info("Shortwave ↓ surface (accum.)", "Time-integrated downward solar flux at the ground", F::Unassigned)),
    ("wrf_acswdnbc", info("Shortwave ↓ surface clear-sky (accum.)", "Time-integrated clear-sky downward solar at the ground", F::Unassigned)),
    ("wrf_aclwupt",  info("Longwave ↑ TOA (accum.)", "Time-integrated outgoing thermal flux at TOA", F::Unassigned)),
    ("wrf_aclwuptc", info("Longwave ↑ TOA clear-sky (accum.)", "Time-integrated clear-sky outgoing thermal flux at TOA", F::Unassigned)),
    ("wrf_aclwdnt",  info("Longwave ↓ TOA (accum.)", "Time-integrated downward thermal flux at TOA", F::Unassigned)),
    ("wrf_aclwdntc", info("Longwave ↓ TOA clear-sky (accum.)", "Time-integrated clear-sky downward thermal flux at TOA", F::Unassigned)),
    ("wrf_aclwupb",  info("Longwave ↑ surface (accum.)", "Time-integrated thermal flux emitted by the ground", F::Unassigned)),
    ("wrf_aclwupbc", info("Longwave ↑ surface clear-sky (accum.)", "Time-integrated clear-sky thermal flux emitted by the ground", F::Unassigned)),
    ("wrf_aclwdnb",  info("Longwave ↓ surface (accum.)", "Time-integrated downward thermal flux at the ground", F::Unassigned)),
    ("wrf_aclwdnbc", info("Longwave ↓ surface clear-sky (accum.)", "Time-integrated clear-sky downward thermal at the ground", F::Unassigned)),
