...
pub use p3_psd::{
    ...
    P3ParticleRegion, P3PiecewiseParticleLaw, P3Psd, P3PsdError, P3PsdInput, P3PsdProvenance,
    P3Quadrature, P3QuadratureAudit, P3QuadratureConfig, P3QuadratureNode, P3ReconstructionConfig,
