...
- Open follow-ups usually live in the session task list; standing ideas: WRF description-attr fallback labels; independent validation and scheme-native PSD integration beyond the T-matrix characteristic-particle research contract; Build 24 operational adaptations beyond the checked base rows; France radar (needs OAuth + BUFR — own project); KNMI 7-year archive (needs KNMI-native HDF5 decoder).
