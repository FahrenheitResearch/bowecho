...
**Design intent:** customizable polygon colors/line thickness, color table overhaul with better defaults plus in-app editing and saving, the green-to-red radar-age ring as a customization, and generally "freedom to customize anything."
